...
const Auth = () => {
  ...
  return (
    <div className='relative w-[700px] h-[700px] bg-zinc-700 rounded-md flex flex-col items-center justify-center gap-4 p-4'>
        <h3 className="text-3xl font-semibold absolute top-4">Welcome To Aora</h3>
